...
namespace System
{
	namespace BasicType
	{
		...
		public:
			...
			std::string ToUTF8Data(const std::string strLocal = "");

			// ANSI string (UTF8->ANSI)
			std::string ToAnsiData(const std::string strLocal = "UTF-8");

			// Wide string (UTF8 / ANSI)
			std::wstring ToWideData(const std::string strLocal = "UTF-8");
